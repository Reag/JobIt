...
public struct MatchPositionJobElement
{
    public Transform Parent;
    public Transform Child;
}

public class MatchPositionJob : UpdateToUpdateJob<MatchPositionJobElement>
{
    ...
    protected override MatchPositionJobElement ReadJobDataAtIndex(int index)
    {
        var ret = new MatchPositionJobElement
        {
